...
description: Development workflow orchestrator for PortfolioTracker. Classifies tasks, creates feature branches, guides implementation, and opens structured PRs. Use when starting any task, creating a branch, or opening a pull request.
---
